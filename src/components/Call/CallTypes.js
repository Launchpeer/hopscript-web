...
export const CALL_LEAD_GROUP_INDEX_UPDATE = 'CALL_LEAD_GROUP_INDEX_UPDATE';
export const CALL_LEAD_GROUP_UPDATE = 'CALL_LEAD_GROUP_UPDATE';
export const CALL_LEAD_GROUP_DETAILS = 'CALL_LEAD_GROUP_DETAILS';
export const CALL_UPDATE_TYPE = 'CALL_UPDATE_TYPE';
